...
namespace Error
{
	...
	ERROR errors[ERROR_MAX_ENTRY] =
	{
		...
		ERROR_ENTRY(122, "Ошибка лексического анализатора: Ошибка с разбором символьного литерала"), 
		...
		ERROR_ENTRY(150, "Ошибка семантического анализа: Тип char может содержать только 1 символ"),
		ERROR_ENTRY(151, "Ошибка семантического анализа: Оператор не предназначен для работы с типом данных char"),
		...
		ERROR_ENTRY(606, "Ошибка синтаксического анализа: Ошибка в конструкции цикла"),
		ERROR_ENTRY(607, "Ошибка синтаксического анализа: Ошибка типа"),
		ERROR_ENTRY(608, "Ошибка синтаксического анализа: Ошибка в структуре блока"),
		ERROR_ENTRY(609, "Ошибка синтаксического анализа: Ошибка в структуре блока"),
