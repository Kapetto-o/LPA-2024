...
namespace GRB
{
	Greibach greibach(
		...
		Rule(
			...
			Rule::Chain(10, TS(LEX_INT), TS(LEX_FUNCTION), TS(LEX_IDENTIFIER), TS('('), TS(')'), TS('{'), NS('N'), TS('}'), TS(';'), NS('S')),
			Rule::Chain(9, TS(LEX_INT), TS(LEX_FUNCTION), TS(LEX_IDENTIFIER), TS('('), TS(')'), TS('{'), NS('N'), TS('}'), TS(';')),
			...
			Rule::Chain(11, TS(LEX_INT), TS(LEX_FUNCTION), TS(LEX_IDENTIFIER), TS('('), NS('F'), TS(')'), TS('{'), NS('N'), TS('}'), TS(';'), NS('S')),
			Rule::Chain(10, TS(LEX_INT), TS(LEX_FUNCTION), TS(LEX_IDENTIFIER), TS('('), NS('F'), TS(')'), TS('{'), NS('N'), TS('}'), TS(';')),
	...
	/*		Rule::Chain(5, TS(LEX_NEW), NS('T'), TS(LEX_IDENTIFIER), TS(';'), NS('N')),
		...
		Rule(
			...
			6,
			Rule::Chain(2, TS(LEX_INT), TS(LEX_IDENTIFIER)),
			Rule::Chain(2, TS(LEX_STR), TS(LEX_IDENTIFIER)),
			Rule::Chain(2, TS(LEX_BOOL), TS(LEX_IDENTIFIER)),
			Rule::Chain(4, TS(LEX_INT), TS(LEX_IDENTIFIER), TS(','), NS('F')),
