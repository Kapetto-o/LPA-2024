...
#define GRAPH_IDENTIFIERS \
	...
	FST::NODE(52, \
		...
		FST::RELATION('y', 1), FST::RELATION('z', 3), FST::RELATION('a', 3), \
		FST::RELATION('b', 3), FST::RELATION('c', 3), FST::RELATION('d', 3), \
		FST::RELATION('e', 3), FST::RELATION('f', 3), FST::RELATION('g', 3), \
		FST::RELATION('h', 3), FST::RELATION('i', 3), FST::RELATION('j', 3), \
		FST::RELATION('k', 3), FST::RELATION('l', 3), FST::RELATION('m', 3), \
		FST::RELATION('n', 3), FST::RELATION('o', 3), FST::RELATION('p', 3), \
		FST::RELATION('q', 3), FST::RELATION('r', 3), FST::RELATION('s', 3), \
		FST::RELATION('t', 3), FST::RELATION('u', 3), FST::RELATION('v', 3), \
		FST::RELATION('w', 3), FST::RELATION('x', 3), FST::RELATION('y', 3), \
		FST::RELATION('z', 3)), \
    FST::NODE(72, \
        FST::RELATION('a', 1), FST::RELATION('b', 1), FST::RELATION('c', 1), \
        FST::RELATION('d', 1), FST::RELATION('e', 1), FST::RELATION('f', 1), \
